...
--
-- Table structure for table `copypasta`
--
...
--
-- Dumping data for table `copypasta`
--

LOCK TABLES `copypasta` WRITE;
/*!40000 ALTER TABLE `copypasta` DISABLE KEYS */;
/*!40000 ALTER TABLE `copypasta` ENABLE KEYS */;
UNLOCK TABLES;
